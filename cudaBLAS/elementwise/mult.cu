...
extern "C" void CuMatMultMatrixD(HeaderD* matHeaderA, HeaderD* matHeaderB, HeaderD* matHeaderRes, long len){
    double* matA;
    double* matB;
    double* matRes;
...
extern "C" void CuMatMultMatrixI(HeaderI* matHeaderA, HeaderI* matHeaderB, HeaderI* matHeaderRes, long len){
    long* matA;
    long* matB;
    long* matRes;
    matA = matHeaderA->data;
