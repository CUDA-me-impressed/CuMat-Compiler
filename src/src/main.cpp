...
int main(int argc, char* argv[], char* envp[]) {
	...
	std::copy_if(args.begin(), args.end(), std::back_inserter(warningLevels), [](std::string s) {return s.rfind("-W", 0) == 0; });
	...
	std::copy_if(args.begin(), args.end(), std::back_inserter(optimiseLevels), [](std::string s) {return s.rfind("-O", 0) == 0; });
