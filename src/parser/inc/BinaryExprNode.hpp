...
class BinaryExprNode : public ExprNode {
   public:
    ...
    void plusCodeGen(llvm::Module* TheModule, llvm::IRBuilder<>* Builder, llvm::Value* lhsVal, llvm::Value* rhsVal,
                     const Typing::Type& lhsType, const Typing::Type& rhsType, llvm::AllocaInst* matAlloc);
};
}  // namespace AST