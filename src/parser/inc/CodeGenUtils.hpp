...
namespace Utils {
    ...
    void
    insertValueAtPointerOffsetValue(IRContext *context, llvm::Value *ptr, llvm::Value *offsetValue, llvm::Value *val);
    ...
    llvm::Value *
    getValueFromMatrixPtr(IRContext *context, llvm::Value *mPtr, llvm::Value *offset, const std::string &name);
